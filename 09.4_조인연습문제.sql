...
FROM employees e
JOIN departments d
ON e.department_id = d.department_id; -- INNER JOIN 106개

SELECT
    *
FROM employees e
LEFT OUTER JOIN departments d
ON e.department_id = d.department_id; -- LEFT OUTER JOIN 107개

SELECT
    *
FROM employees e
RIGHT OUTER JOIN departments d
ON e.department_id = d.department_id; -- RIGHT OUTER JOIN 122개

SELECT
    *
FROM employees e
FULL OUTER JOIN departments d
ON e.department_id = d.department_id; -- FULL OUTER JOIN 123개
